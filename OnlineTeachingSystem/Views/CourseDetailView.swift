...
struct CourseDetailView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            }.sheet(isPresented: $showVideosDetail) {
                ScrollView {
                    VStack {
                        Text("课程视频").font(.title)
...
//                                    VideoCellView(videoCellModel: video, studentVideo: StudentVideoModel(student_id: db_single_student_video1.student_id, video_id: db_single_student_video1.video_id, studyLength: db_single_student_video1.study_length, lastTimePoint: db_single_student_video1.last_time_point))
                        }
...
//            .navigationTitle(Text("课程视频")).navigationBarTitleDisplayMode(.automatic)
